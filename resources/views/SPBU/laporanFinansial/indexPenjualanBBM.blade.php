...
<div class="mt-1 mb-1 p-2 bg-red-600">
    <div class="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 grid-rows-1 gap-2">
        <div class="col-start-1 col-end-4">
            <div class="h-15 bg-blue-500 aspect-[16/9]"></div>
        </div>
        <div class="grid grid-rows-2 gap-2">
            <div class="grid grid-rows-1 gap-2">
                <div class="h-15 bg-blue-500 aspect-auto"></div>
            </div>
            <div class="grid grid-rows-1 gap-2">
                <div class="h-15 bg-blue-500 aspect-auto"></div>
            </div>
    ...
    <div class="mt-2 mb-1 grid grid-cols-4 grid-rows-1 gap-2">
        <div class="h-15 bg-blue-500 aspect-square"></div>
        <div class="h-15 bg-blue-500 aspect-square"></div>
        <div class="h-15 bg-blue-500 aspect-square"></div>
        <div class="h-15 bg-blue-500 aspect-square"></div>
    </div>
...
<div class="flex flex-wrap -mx-3 mt-0">
    ...
    <div class="w-full px-3 mb-2 md:mb-1">
        <div class="flex justify-between">
            ...
            <div>
                <form id="rangeFilter" action="/LaporanFinansialSPBU/PenjualanBBM/FilterRange" class="py-0.5" method="GET">
                    <div class="flex">
                        <div class="mr-5">
...
<div class="w-full max-w-full px-3 mt-4 lg:w-full lg:flex-none">
    <div class="border-black/12.5 shadow-inner relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-gray-50 bg-clip-border">
                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row justify-between -mx-3">
                            ...
                            <div>
                                ...
                                <div class="flex mt-2">
                                    <div class="flex">
                                        ...
                                        <div class="ml-1"><span class="leading-normal font-bold font-weight-bolder text-lime-500">{{ number_format($totalLiter) }}
                                                Liter</span></div>
                                    </div>
                                    <div class="flex ml-3">
                                        ...
                                        <div class="ml-1"><span class="leading-normal font-bold font-weight-bolder text-red-500">{{ number_format($totalPenyusutan) }}
                                                Liter</span></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="px-3 text-right">
                            <div class="inline-block w-[98px] h-[98px] text-center rounded-lg bg-gradient-to-tl from-[#060764] to-[#00b7dd]">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex mt-0.38 w-full">
                                            <div class="flex">
                                                ...
                                                <div class="ml-1"><span class="leading-normal text-[13px] font-bold font-weight-bolder text-lime-500">{{ number_format($liter) }}
                                                        Liter</span></div>
                                            </div>
                                            <div class="flex ml-1.5">
                                                ...
                                                <div class="ml-1"><span class="leading-normal text-[13px] font-bold font-weight-bolder text-red-500">{{ number_format($penyusutan) }}
                                                        Liter</span></div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="p-2 text-center align-middle bg-transparent border-b-0 whitespace-nowrap shadow-transparent">
                            <span class="font-semibold leading-tight text-xs text-slate-400">{{ $sells[0]->stock_adm }}</span>
                        </td>
                        <td class="p-2 text-center align-middle bg-transparent border-b-0 whitespace-nowrap shadow-transparent">
                            <span class="font-semibold leading-tight text-xs text-slate-400">{{ $sells[0]->stock_fakta }}</span>
                        </td>
                        <td class="p-2 text-center align-middle bg-transparent border-b-0 whitespace-nowrap shadow-transparent">
                    ...
                    <tr>
                        ...
                        <td class="p-2 text-center align-middle bg-transparent border-t whitespace-nowrap shadow-transparent">
                            <span class="font-semibold leading-tight text-xs text-slate-400">{{ $sell->stock_adm }}</span>
                        </td>
                        <td class="p-2 text-center align-middle bg-transparent border-t whitespace-nowrap shadow-transparent">
                            <span class="font-semibold leading-tight text-xs text-slate-400">{{ $sell->stock_fakta }}</span>
                        </td>
                        <td class="p-2 text-center align-middle bg-transparent border-t whitespace-nowrap shadow-transparent">

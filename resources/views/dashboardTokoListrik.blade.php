                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-open font-semibold leading-normal text-sm">Total Penjualan Barang
                                </p>
        ...
        <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
            <div
                ...
                <div class="flex-auto p-4">
                    ...
                    <h6 class="mt-6 mb-0 ml-2 invisible">Active Users</h6>
                    <p class="ml-2 leading-normal text-sm invisible">(<span class="font-bold">+23%</span>) than last week</p>
                    <div class="w-full px-6 mx-auto max-w-screen-2xl rounded-xl invisible">
        ...
        <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
            <div
                ...
                <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                    ...
                    <p class="leading-normal text-sm invisible">

...
<div class="flex flex-wrap -mx-3 mt-0">
    ...
    <div class="w-full px-3 mb-2 md:mb-1">
        <div class="flex justify-between">
            ...
            <div>
                <form id="rangeFilter" action="/LaporanFinansialBBM/PenjualanBBM/FilterRange" class="py-0.5" method="GET">
                    <div class="flex">
                        <div class="mr-5">
...
<div class="flex flex-wrap -mx-2">
                        ...
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                ...
                                <h5 class="mb-0 text-[18px] font-bold">
                                    @currency($revenue) </h5>
                                <span class="leading-normal text-[13px] font-bold font-weight-bolder text-lime-500">{{ $liter }}
                                    Liter</span>
                                <span class="leading-normal text-[13px] font-bold font-weight-bolder text-red-500">{{ $penyusutan }}
                                    Liter</span>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
                            <div class="inline-block w-14 h-14 text-center rounded-lg bg-gradient-to-tl from-[#060764] to-[#00b7dd]">
                        ...
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    ...
                                    <span class="leading-normal text-[13px] font-bold font-weight-bolder text-lime-500">{{ $totalLiter }}
                                        Liter</span>
                                    <span class="leading-normal text-[13px] font-bold font-weight-bolder text-red-500">{{ $totalPenyusutan }}
                                        Liter</span>
                                </div>
                            </div>
                            <div class="px-3 text-right basis-1/3">
    ...
    <div class="bg-blue-500 w-full max-w-full px-3 lg:w-1/2 lg:flex-none">
        d
    </div>
</div>

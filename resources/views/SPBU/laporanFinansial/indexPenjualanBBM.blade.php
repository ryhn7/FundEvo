                    ...
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                            ...
                            <h5 class="mb-0 font-bold">
                                @currency($revenue) </h5>
                            <span class="leading-normal text-sm font-weight-bolder text-lime-500">{{ $liter }}
                                Liter</span>
                        </div>
                        <span class="leading-normal text-sm font-weight-bolder text-lime-500">{{ $penyusutan }}
                            Liter</span>
                    </div>
                ...
                <div class="flex flex-row -mx-3">
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                            ...
                            <span class="leading-normal text-sm font-weight-bolder text-lime-500">{{ $totalLiter }}
                                Liter</span>
                        </div>

...
<div class="w-full px-3 overflow-hidden rounded-lg shadow-xs">
    ...
    <div class="flex justify-end mb-5 mr-1">
        <div class="flex w-44 px-2 py-1 rounded-md shadow-lg text-center group bg-gradient-to-tl from-sky-500 to-teal-500 hover:bg-gradient-to-tl hover:from-sky-600 hover:to-teal-600">
            ...
            <div class="text-sm text-white font-semibold group-hover:font-bold"><a href="/kategori/create">Tambah
                    kategori</a></div>
        </div>
    </div>
        ...
        <table class="bg-white w-full whitespace-no-wrap">
            <thead>
                <tr class="text-xs font-semibold tracking-wide text-left text-gray-700 uppercase border-b">
                    ...
                    <th class="pl-9 py-3">Aksi</th>
                </tr>
            </thead>
            <tbody class="bg-white divide-y">
                @foreach ($kategoris->sortBy('kategori') as $kategori)

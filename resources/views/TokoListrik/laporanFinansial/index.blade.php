                                        ...
                                        <ul class=" dropdown-menu min-w-max absolute hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded-lg shadow-lg mt-1 hidden m-0 bg-clip-padding border-none"
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul
                                                    ...
                                                    <form id="monthFilter"
                                                        action="/LaporanFinansialTokoListrik/PenjualanItem/FilterBulan"
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul
                                                    ...
                                                    <form id="yearFilter"
                                                        action="/LaporanFinansialTokoListrik/PenjualanItem/FilterTahun"
                                                        class="py-0.5" method="GET">
                            ...
                            @if (request()->is('LaporanFinansialTokoListrik'))
                                <div class="w-full px-3 mb-2 md:mb-1">
                                    <div class="flex justify-between">
                                        ...
                                        <div>
                                            <form id="rangeFilter" action="/LaporanFinansialTokoListrik/PenjualanItem/FilterRange"
                                                class="py-0.5" method="GET">
                                                <div class="flex">
                                                    <div class="mr-5">

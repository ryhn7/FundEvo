    ...
    <ul class=" dropdown-menu min-w-max absolute hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded-lg shadow-lg mt-1 hidden m-0 bg-clip-padding border-none"
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-content absolute hidden text-gray-700 -pl-5 -ml-[177px] -mt-10">
                <form id="monthFilter" action="/LaporanFinansialTokoListrik/PengeluaranTokoListrik/FilterBulan" class="py-0.5" method="GET">
        ...
        <li class="dropdown">
            <div
                class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100">
                Tahun</div>
            <ul class="dropdown-content absolute hidden text-gray-700 -pl-5 -ml-[203px] -mt-10">
                <form id="yearFilter" action="/LaporanFinansialTokoListrik/PengeluaranTokoListrik/FilterTahun" class="py-0.5" method="GET">
...
@section('laporan')
    <div class="flex flex-wrap -mx-3 mt-0">
        ...
        @if (request()->is('LaporanFinansialTokoListrik/PengeluaranTokoListrik'))
            <div class="w-full px-3 mb-2 md:mb-1">
                <div class="flex justify-between">
                    <div class="px-4 py-5">Filter by time range</div>
                    <div>
                        <form id="rangeFilter" action="/LaporanFinansialTokoListrik/PengeluaranTokoListrik/FilterRange" class="py-0.5"
                            method="GET">
                            <div class="flex">
                                <div class="mr-5">
                        ...
                        <thead class="align-bottom">
                            <tr>
                                ...
                                <th
                                    ...
                                    @sortablelink('biaya_kulakan', 'Biaya Kulakan')
                                </th>
                                <th
                                    class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                    @sortablelink('pbb', 'PBB')</th>
                                <th
                                    class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                    Gaji Karyawan</th>
                                <th

        ...
        <form action="/pengeluaran-ops-bbm/{{ $spend->id }}" method="POST">
            ...
            <div>
                <label for="harga_penebusan_bbm" class="block mt-4 text-sm">
                    <span class="text-gray-700 font-semibold">Harga Penebusan <span class="text-[10px] text-[#42dc7a] tracking-wider">(Optional)</span></span>
                ...
                <label for="nota" class="block mt-4 text-sm">
                    ...
                    <input type="text" id="nota" name="nota" value="{{ old('nota', $spend->nota) }}"
